...
const activeCls =
  "pointer-events-none border-cyan-400/50 bg-gradient-to-r from-cyan-500/12 to-violet-600/12 text-white shadow-[0_0_20px_rgba(34,211,238,0.08)]";

export function ProfileLayoutSidebar() {
  const kioskHref = "/kiosk";
