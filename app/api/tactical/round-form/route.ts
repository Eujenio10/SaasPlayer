...
import { fetchCompetitionRoundPlayerPerformances } from "@/services/sportapi";
...
export async function GET(request: Request) {
  ...
  try {
    const performance = await fetchCompetitionRoundPlayerPerformances({
    ...
    const message = error instanceof Error ? error.message : "round_form_failed";
