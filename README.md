...
- `TACTICAL_LOOKAHEAD_DAYS` giorni di discovery calendario club/UEFA (default = `MATCHES_WINDOW_DAYS`, oggi `30`). Deve essere ≥ alla finestra menu, altrimenti partite lontane non vengono mai scaricate.
