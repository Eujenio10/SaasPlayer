...
- `TACTICAL_LOOKAHEAD_DAYS` giorni di discovery calendario club/UEFA. Il codice usa **almeno** `MATCHES_WINDOW_DAYS` (oggi `30`), anche se in env metti un valore più basso. Consigliato su Vercel: `35` o superiore.
