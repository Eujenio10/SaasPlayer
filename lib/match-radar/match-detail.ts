...
function insightLine(
  ...
  if (locale === "it") {
    ...
    return diff > 0
      ? "I dati indicano pressione sulle fasce: molti corner creati in casa rispetto a quelli concessi in trasferta."
      : "I dati indicano più corner generati dalla trasferta rispetto a quelli concessi dalla casa.";
  }
  ...
  return diff > 0
    ? "The data indicate wing pressure: home creates more corners than the away side typically concedes."
    : "The data indicate more corners generated by the away side than home typically allows.";
}
